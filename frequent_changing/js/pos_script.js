...
$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response.order_type == 1) {
          ...
          order_type = "Delivery";
          order_type_id = 3;
        } else if (response.order_type == 4) {
          order_type = "Swiggy";
          order_type_id = 4;
        } else if (response.order_type == 5) {
          order_type = "Zomato";
          order_type_id = 5;
        } else if (response.order_type == 6) {
          order_type = "Channel 1";
          order_type_id = 6;
        } else if (response.order_type == 7) {
          order_type = "Channel 2";
          order_type_id = 7;
        } else if (response.order_type == 8) {
          order_type = "Channel 3";
          order_type_id = 8;
        }
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if (order_type == 1) {
            ...
            order_number = "D " + order_object.sale_no;
            order_type_name = "Swiggy";
          } else if (order_type == 5) {
            order_number = "E " + order_object.sale_no;
            order_type_name = "Zomato";
          } else if (order_type == 6) {
            order_number = "F " + order_object.sale_no;
            order_type_name = "Channel 1";
          } else if (order_type == 7) {
            order_number = "G " + order_object.sale_no;
            order_type_name = "Channel 2";
          } else if (order_type == 8) {
            order_number = "H " + order_object.sale_no;
            order_type_name = "Channel 3";
          }
          let tables_booked = "";
          ...
          for (let key in order_object.items) {
            ...
            if (single_item.item_type == "Kitchen Item") {
              ...
              if (single_item.cooking_status == "Started Preparing") {
  ...
  $(document).on(
    "click",
    "#dine_in_button,#take_away_button,#delivery_button,#swiggy_button,#zomato_button,#channel1_button,#channel2_button,#channel3_button",
    function (e) {
      $("#dine_in_button").css("border", "unset");
      $("#take_away_button").css("border", "unset");
      $("#delivery_button").css("border", "unset");
      $("#swiggy_button").css("border", "unset");
      $("#zommato_button").css("border", "unset");
      $("#channel1_button").css("border", "unset");
      $("#channel2_button").css("border", "unset");
      $("#channel3_button").css("border", "unset");
      ...
      } else if ($(this).attr("id") == "swiggy_button") {
        $("#table_button").attr("disabled", true);
        $(".single_table_div[data-table-checked=checked]").attr(
          "data-table-checked",
          "unchecked"
      ...
      } else if ($(this).attr("id") == "zomato_button") {
        $("#table_button").attr("disabled", true);
        $(".single_table_div[data-table-checked=checked]").attr(
          "data-table-checked",
          "unchecked"
      ...
      } else if ($(this).attr("id") == "channel1_button") {
        $("#table_button").attr("disabled", true);
        $(".single_table_div[data-table-checked=checked]").attr(
          "data-table-checked",
          "unchecked"
      ...
      } else if ($(this).attr("id") == "channel2_button") {
        $("#table_button").attr("disabled", true);
        $(".single_table_div[data-table-checked=checked]").attr(
          "data-table-checked",
          "unchecked"
      ...
      } else if ($(this).attr("id") == "channel3_button") {
        $("#table_button").attr("disabled", true);
        $(".single_table_div[data-table-checked=checked]").attr(
          "data-table-checked",
          "unchecked"
  ...
  $(document).on("click", "#place_order_operation", function (e) {
    ...
    if (selected_order_type_object.length > 0) {
      ...
      } else if (selected_order_type_object.attr("id") == "swiggy_button") {
        order_type = 4;
      ...
      } else if (selected_order_type_object.attr("id") == "zomato_button") {
        order_type = 5;
      ...
      } else if (selected_order_type_object.attr("id") == "channel1_button") {
        order_type = 6;
      ...
      } else if (selected_order_type_object.attr("id") == "channel2_button") {
        order_type = 7;
      ...
      } else if (selected_order_type_object.attr("id") == "channel3_button") {
        order_type = 8;
      ...
      $("#swiggy_button").css("border", "1px solid red");
      $("#zommato_button").css("border", "1px solid red");
      $("#channel1_button").css("border", "1px solid red");
      $("#channel2_button").css("border", "1px solid red");
      $("#channel3_button").css("border", "1px solid red");
    }
  });
...
function show_all_items() {
  ...
  $(document).on("click", "#hold_cart_info", function (e) {
    ...
    if (selected_order_type_object.attr("id") == "delivery_button") {
      ...
      order_type = 4;
    } else if (selected_order_type_object.attr("id") == "zommato_button") {
      order_type = 5;
    } else if (selected_order_type_object.attr("id") == "channel1_button") {
      order_type = 6;
    } else if (selected_order_type_object.attr("id") == "channel2_button") {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (response.order_type == 1) {
        ...
        order_type = "Swiggy";
        order_type_id = 4;
        order_number = "D " + response.sale_no;
      } else if (response.order_type == 5) {
        order_type = "Zomato";
        order_type_id = 5;
        order_number = "E " + response.sale_no;
      } else if (response.order_type == 6) {
        order_type = "Channel 1";
        order_type_id = 6;
        order_number = "F " + response.sale_no;
      } else if (response.order_type == 7) {
        order_type = "Channel 2";
        order_type_id = 7;
        order_number = "G " + response.sale_no;
      } else if (response.order_type == 8) {
        order_type = "Channel 3";
        order_type_id = 8;
        order_number = "H " + response.sale_no;
      }
  ...
  let delivery_charge_amount = 0;
    ...
    $(".selected__btn_c").each(function() {
        ...
        if(this_selected_name=="selected"){
            if(charge_type_custom=="delivery" && (this_id_name!="dine_in_button")){
                countable_d_c = 'yes';
            }
            if(charge_type_custom=="service"  && (this_id_name!="take_away_button" && this_id_name!="delivery_button" && this_id_name!="swiggy_button" && this_id_name!="zomato_button" && this_id_name!="channel1_button" && this_id_name!="channel2_button" && this_id_name!="channel3_button")){
                countable_d_c = 'yes';
            }
        }
    });
    ...
    success: function (response) {
      ...
      for (let key in response) {
        ...
        order_list_left +=
          ...
          "</span></p>";
        order_list_left +=
          '<p>Champion: <span class="running_order_waiter_name">' +
          waiter_name +
          "</span></p>";
        order_list_left +=
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (let key in response) {
        ...
        order_list_left += '<div class="order_condition">';
        order_list_left +=
          '<p class="order_on_processing">Started Preparing: ' +
          total_kitchen_type_started_cooking_items +
          "/" +
          total_kitchen_type_items +
          "</p>";
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (response.order_type == "1") {
        ...
        // $("#swiggy_zommato_button").css("background-color", "#B5D6F6");
        $("#swiggy_button").attr("data-selected", "selected");
        ...
        // $("#swiggy_zommato_button").css("background-color", "#B5D6F6");
        $("#zomato_button").attr("data-selected", "selected");
        ...
        // $("#swiggy_zommato_button").css("background-color", "#B5D6F6");
        $("#channel1_button").attr("data-selected", "selected");
        ...
        // $("#swiggy_zommato_button").css("background-color", "#B5D6F6");
        $("#channel2_button").attr("data-selected", "selected");
        ...
        // $("#swiggy_zommato_button").css("background-color", "#B5D6F6");
        $("#channel3_button").attr("data-selected", "selected");
...
function get_details_of_a_particular_order_for_modal(sale_id) {
  $.ajax({
    ...
    success: function (response) {
      ...
      $("#order_details_customer_name").html(response.customer_name +" ("+ response.customer_phone+")");
...
//Start Today Sumurry Added by kartik
$(document).on("click", "#today_details", function (e) {
  let todayPurchaseOnly = 0.00;
  let todaySale = 0.00;
  let todayTotalTax  = 0.00;
  let todayExpense = 0.00;
  let todaySupplierDuePayment = 0.00;
  let todayCustomerDueReceive = 0.00;
  let todayWaste = 0.00;
  let todayBalance = 0.00;
  let register_detail_modal_content = "";
  ...
  $.ajax({
    ...
    success: function (response) {
      console.log(response);
      response = JSON.parse(response);
      $("#today_summury_modal").addClass("active");
      $(".pos__modal__overlay").fadeIn(200);
      register_detail_modal_content += "<p>"+"Purchase(Only Paid Amount)"+ " : " + response.total_purchase_amount +"</p>";
      register_detail_modal_content += "<p>"+"Sale(Only Paid Amount)"+ " : " + response.total_sales_amount +"</p>";
      register_detail_modal_content += "<p>"+"Total Tax"+ " : " + response.total_sales_vat +"</p>";
      register_detail_modal_content += "<p>"+"Expense"+ " : " + response.expense_amount +"</p>";
      register_detail_modal_content += "<p>"+"Supplier Due Payment"+ " : " + response.supplier_payment_amount +"</p>";
      register_detail_modal_content += "<p>"+"Customer Due Receive"+ " : " + response.customer_receive_amount +"</p>";
      register_detail_modal_content += "<p>"+"Waste"+ " : " + response.total_loss_amount +"</p>";
      register_detail_modal_content += "<p>"+"Balance"+ " : " + response.balance +"</p>";
      $("#today_details_content").html(register_detail_modal_content);
      // $('#myModal').modal('hide');
    },
    error: function () {
      alert("error");
...
$("body").on("click", ".removeCartItem", function () {
  ...
  if (waiter_app_status == "Yes" && sale_no != undefined) {
    ...
    if (role != "Admin") {
      if (current_status == "Started Preparing") {
        swal({
          title: warning,
    ...
    success: function (response) {
      ...
      for (let key in orders) {
        ...
        if (orders[key].order_type == "1") {
          ...
          order_name = "C " + orders[key].sale_no;
        } else if (orders[key].order_type == "4") {
          order_name = "D " + orders[key].sale_no;
        } else if (orders[key].order_type == "5") {
          order_name = "E " + orders[key].sale_no;
        } else if (orders[key].order_type == "6") {
          order_name = "F " + orders[key].sale_no;
        } else if (orders[key].order_type == "7") {
          order_name = "G " + orders[key].sale_no;
        } else if (orders[key].order_type == "8") {
          order_name = "H " + orders[key].sale_no;
        }
        let tables_booked = "";
        if (orders[key].tables_booked.length > 0) {
          let w = 1;
