...
$(document).ready(function () {
  ...
  $("#dine_in_button,#take_away_button,#delivery_button,#swiggy_button,#zommato_button,#channel1_button,#channel2_button,#channel3_button").on(
    "click",
    function () {
      ...
      $("#swiggy_button").css("border", "1px solid #A9BDCC");
      $("#zomato_button").css("border", "1px solid #A9BDCC");
      $("#channel1_button").css("border", "1px solid #A9BDCC");
      $("#channel2_button").css("border", "1px solid #A9BDCC");
      $("#channel3_button").css("border", "1px solid #A9BDCC");
      ...
      if ($(this).attr("id") == "dine_in_button") {
        ...
        // $('.single_table_div[data-table-checked=checked]').css('background-color', '#ffffff');
      } else if ($(this).attr("id") == "zommato_button") {
        $("#table_button").attr("disabled", true);
        $(".single_table_div[data-table-checked=checked]").attr(
          "data-table-checked",
          "unchecked"
  ...
  $("#place_order_operation").on("click", function () {
    ...
    if (selected_order_type_object.length > 0) {
      ...
      $("#swigg_button").css("border", "1px solid red");
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (response.order_type == "1") {
        ...
        $("#swiggy_button").css("background-color", "#B5D6F6");
        ...
        $("#zomato_button").css("background-color", "#B5D6F6");
        ...
        $("#channel1_button").css("background-color", "#B5D6F6");
        ...
        $("#channel2_button").css("background-color", "#B5D6F6");
        ...
        $("#channel3_button").css("background-color", "#B5D6F6");
