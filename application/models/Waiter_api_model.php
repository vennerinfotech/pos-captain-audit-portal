        ...
        if($data){
            if($data->role=="Admin"){
                ...
                if(!isAccess($data->id) && $data->will_login=="Yes"){
                    $return_details['status'] = false;
                    $return_details['msg'] = "You have not access for Champion Panel";
                ...
                }else if($data->designation!="Champion"){
                    $return_details['status'] = false;
                    $return_details['msg'] = "Only Admin or Champion user can login, check documentation for detail";
                }else if($data->designation!="Champion"){
                ...
                }else if($data->designation=="Champion" && $data->will_login=="Yes" && $data->active_status=="Active"){
                    $return_details['status'] = true;
                    $return_details['data'] = $data;
                    $return_details['msg'] = "Successfully login";
                }
