...
class Inventory_model extends CI_Model {
    ...
    public function getInventory($category_id = "", $ingredient_id = "", $food_id = "") {
        ...
        (SELECT sum(consumption) FROM tbl_sale_consumptions_of_menus INNER JOIN tbl_sales ON tbl_sale_consumptions_of_menus.sales_id = tbl_sales.id WHERE tbl_sale_consumptions_of_menus.outlet_id = $outlet_id AND tbl_sale_consumptions_of_menus.ingredient_id = i.ingredient_id AND tbl_sales.order_status = '3') total_consumption,
        ...
        (SELECT sum(consumption) FROM tbl_sale_consumptions_of_modifiers_of_menus INNER JOIN tbl_sales ON tbl_sale_consumptions_of_modifiers_of_menus.sales_id = tbl_sales.id WHERE tbl_sale_consumptions_of_modifiers_of_menus.outlet_id = $outlet_id AND tbl_sale_consumptions_of_modifiers_of_menus.ingredient_id = i.ingredient_id AND tbl_sales.order_status = '3') total_modifiers_consumption,
...
(select SUM(quantity_amount) from tbl_transfer_received_ingredients  where ingredient_id=i.id AND from_outlet_id=$outlet_id AND  tbl_transfer_received_ingredients.del_status='Live' AND (tbl_transfer_received_ingredients.status=1)) total_transfer_minus_2
        ...
        (SELECT sum(consumption) FROM tbl_sale_consumptions_of_menus INNER JOIN tbl_sales ON tbl_sale_consumptions_of_menus.sales_id = tbl_sales.id WHERE tbl_sale_consumptions_of_menus.outlet_id = $outlet_id AND tbl_sale_consumptions_of_menus.ingredient_id = i.id AND tbl_sales.order_status = '3') total_consumption,
        ...
        (SELECT sum(consumption) FROM tbl_sale_consumptions_of_modifiers_of_menus INNER JOIN tbl_sales ON tbl_sale_consumptions_of_modifiers_of_menus.sales_id = tbl_sales.id WHERE tbl_sale_consumptions_of_modifiers_of_menus.outlet_id = $outlet_id AND tbl_sale_consumptions_of_modifiers_of_menus.ingredient_id = i.id AND tbl_sales.order_status = '3') total_modifiers_consumption,
