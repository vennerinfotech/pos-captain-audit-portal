...
class Orderstatus_model extends CI_Model {
    ...
    public function getNewOrders($outlet_id){
        ...
        $this->db->where("tbl_sales.order_status", "Live");
     ...
     /**
     * get total Orderstatus type items
     * @access public
     * @return object
     * @param int
     */
    public function get_total_Orderstatus_type_items($sale_id)
    {
        $this->db->select('id');
     ...
     /**
     * get total orderstatus type done items
     * @access public
     * @return object
     * @param int
     */
    public function get_total_Orderstatus_type_done_items($sale_id)
    {
        $this->db->select('id');
        $this->db->from('tbl_sales_details');
        $this->db->where("sales_id", $sale_id);
     ...
     * @param int
     */
    public function get_total_Orderstatus_type_started_cooking_items($sale_id)
    {
        $this->db->select('id');
        $this->db->from('tbl_sales_details');
        $this->db->where("sales_id", $sale_id);
     ...
     * @param int
     */
    public function getAllOrderstatusItemsFromSalesDetailBySalesId($sales_id){
