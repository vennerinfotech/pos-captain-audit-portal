 ...
 */ 
    ...
    if(count($getUnReadyOrders)>0){
        ...
        foreach($getUnReadyOrders as $singleOrder){
            ...
            }elseif($singleOrder->order_type==4){
                $order_type = "Swiggy";
                $order_name = "D ".$singleOrder->sale_no;
            }elseif($singleOrder->order_type==5){
                $order_type = "Zomato";
                $order_name = "E ".$singleOrder->sale_no;
            }elseif($singleOrder->order_type==6){
                $order_type = "Channel 1";
                $order_name = "F ".$singleOrder->sale_no;
            }elseif($singleOrder->order_type==7){
                $order_type = "Channel 2";
                $order_name = "G ".$singleOrder->sale_no;
            }elseif($singleOrder->order_type==8){
                $order_type = "Channel 3";
                $order_name = "H ".$singleOrder->sale_no;
            }
            $tables_booked = '';
