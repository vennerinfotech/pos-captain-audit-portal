...
<body>
    <div id="wrapper">
        <div id="receiptData">
            ...
            <div id="receipt-data">
                <div class="ir_txt_center" style="font-size: 15px;">
                    <h1 class="ir_txt_center"><?php echo lang('KOT'); ?></h1>
                  <?php echo lang('Invoice_No'); ?><b>: </b><?php echo escape_output($kot_info->order_number); ?><br>
                   <?php echo lang('date'); ?>: <?php echo escape_output($kot_info->order_date); ?>
					 <br>
                <?php echo lang('customer'); ?>:
                    <b><?php echo "$kot_info->customer_name"; ?> <?= isset($kot_info->table_name) && $kot_info->table_name ?lang('table_no').": ".$kot_info->table_name : '' ?><br></b>
                   <!--<?php echo lang('waiter'); ?>: <?php echo "$kot_info->waiter_name"; ?>--><?php echo lang('order_type'); ?>:
                ...
                <table class="table table-condensed">
                    <thead>
                        <tr class="ir_font_bold">
                            ...
                            <td class="ir_w_10 ir_txt_center" style="font-size: 15px;"><?php echo lang('qty'); ?></td>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            if (isset($kot_info->items)) {
                                ...
                                foreach ($kot_info->items as $row) {
                                    ...
                                    ?>
                        <tr>
                            <td style="font-size: 15px;"><?php echo escape_output($i++); ?></td>
                            <td style="font-size: 15px;">
                                <?php echo escape_output($row->kot_item_name) ?> <br>
                                <?php if($row->modifiers){ echo lang('modifiers').":". $row->modifiers."<br>";}?>
                            </td>
                            <td class="ir_txt_center" style="font-size: 15px;"><?php echo escape_output($row->tmp_qty) ?> </td>
                        </tr>
                        <?php
                                endif;
                                }
