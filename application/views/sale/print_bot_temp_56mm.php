        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
                ...
                <?php echo lang('customer'); ?><b>: </b>
                    <b><?php echo escape_output("$kot_info->customer_name"); ?> <?= isset($kot_info->table_name) && $kot_info->table_name ?lang('table_no').": ".escape_output($kot_info->table_name) : '' ?><br></b>
