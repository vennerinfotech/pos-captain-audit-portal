        ...
        <div id="receiptData">
            ...
            <div id="receipt-data">
                <div class="text-center">
                    ...
                    <p style="font-size: 11px;"><?php echo escape_output($this->session->userdata('address')); ?>
                        <br>
                       <?php echo lang('phone'); ?>: <?php echo escape_output($this->session->userdata('phone')); ?>
                        ...
                        <br>
                        <?php echo "GSTIN"; ?>: <?php
                            $outlet = $this->Common_model->getDataById($this->session->userdata('outlet_id'), "tbl_outlets");
                            echo escape_output($outlet->gstnumber);
                        endif;
                            ?>
                            <br>
                        <?php echo lang('Foodlicense_Registration_No'); ?>: <?php
                        	$outlet = $this->Common_model->getDataById($this->session->userdata('outlet_id'), "tbl_outlets");
                            echo escape_output($outlet->foodlicense);
                            ?>
               ...
               <p style="font-size: 11px;"><?php echo lang('date'); ?>:<?= escape_output(date($this->session->userdata('date_format'), strtotime($sale_object->sale_date))); ?>
                   ...
                   <!-- <?= ($sale_object->waiter_name ? "<br>".lang('waiter').": <b>" . escape_output($sale_object->waiter_name)."</b>" : '') ?>-->
                    ...
                    <?php } ?>
				   <?php if($sale_object->customer_phone!=NULL  && $sale_object->customer_phone!=""){?>
                    <br /><?php echo lang('phone'); ?>:<?php echo escape_output("$sale_object->customer_phone"); ?>
                    <?php } ?>
                ...
                <table class="table table-condensed">
                    <tbody>
                        ...
                        <tr>
                            <td class="no-border border-bottom ir_wid_70" style="font-size: 11px;"><?php echo escape_output($row->menu_name) ?>
                                <small></small> <?php echo "$row->qty X $menu_unit_price"; ?>
                            </td>
                            <td class="no-border border-bottom text-right" style="font-size: 11px;">
                                <?php echo escape_output(getAmt($row->menu_price_without_discount)); ?>
                            </td>
                        </tr>
                        <?php if(count($row->modifiers)>0){ ?>
                        <tr>
                            <td class="no-border border-bottom" style="font-size: 11px;"><?php echo lang('modifier'); ?>:
                                <small></small>
                                <?php
                                            $l = 1;
                                            $modifier_price = 0;
                    ...
                    <tfoot>
                        ...
                        <tr>
                           <th style="font-size: 9px;"><?php echo lang('sub_total'); ?></th>
                            <th class="text-right" style="font-size: 9px;">
                        ...
                        ?>
                        <tr>
                        <th style="font-size: 9px;"><?php echo lang('Disc_Amt_p'); ?>:</th>
                        <th class="text-right" style="font-size: 9px;">
                        ...
                        ?>
                        <tr>
                       <th style="font-size: 9px;"><?php echo lang($sale_object->charge_type); ?></th>
                        <th class="text-right" style="font-size: 9px;">
                        ...
                        <?php foreach(json_decode($sale_object->sale_vat_objects) as $single_tax){ ?>
                            ...
                            if($single_tax->tax_field_amount && $single_tax->tax_field_amount!="0.00"):
                                ?>
                        <tr>
                            <th style="font-size: 9px;"><?php echo escape_output($single_tax->tax_field_type) ?></th>
                            <th class="text-right" style="font-size: 9px;">
                        ...
                        ?>
                        <tr>
                          <th style="font-size: 9px;"><?php echo lang('grand_total'); ?></th>
                            <th class="text-right" style="font-size: 9px;">
                        ...
                        ?>
                        <tr>
                          <th style="font-size: 9px;"><?php echo lang('paid_amount'); ?></th>
                            <th class="text-right" style="font-size: 9px;">
                        ...
                        ?>
                        <tr>
                           <th style="font-size: 9px;"><?php echo lang('due_amount'); ?></th>
                            <th class="text-right" style="font-size: 9px;">
                        ...
                        ?>
                        <tr>
                           <th style="font-size: 9px;"><?php echo lang('given_amount'); ?></th>
                            <th class="text-right" style="font-size: 9px;">
                        ...
                        ?>
                        <tr>
                           <th style="font-size: 9px;"><?php echo lang('change_amount'); ?></th>
                            <th class="text-right" style="font-size: 9px;">
                ...
                <table class="table table-striped table-condensed">
                    <tbody>
                        <tr>
                            <td style="font-size: 9px;"><?php echo lang('total_payable'); ?></td>
