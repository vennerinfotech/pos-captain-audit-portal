...
foreach ($waiters as $waiter){
    ...
    if($waiter->full_name=='Default Champion'){
...
foreach($new_orders as $single_new_order){
    ...
    }else if($single_new_order->order_type=='4'){
        $order_name = 'D '.$single_new_order->sale_no;
    }else if($single_new_order->order_type=='5'){
        $order_name = 'E '.$single_new_order->sale_no;
    }else if($single_new_order->order_type=='6'){
        $order_name = 'F '.$single_new_order->sale_no;
    }else if($single_new_order->order_type=='7'){
        $order_name = 'G '.$single_new_order->sale_no;
    }else if($single_new_order->order_type=='8'){
        $order_name = 'H '.$single_new_order->sale_no;
    }
...
<body>
    ...
    <input type="hidden" id="has_kitchen" value="<?php echo escape_output($this->session->userdata('has_kitchen'))?>">
        ...
        <div class="top_header_part">
            <div class="left_item">
                <div class="header_part_middle">
                    <ul class="icon__menu">
						...
						<li>
                            <a href="#" id="today_details" class="header_menu_icon"
                                data-tippy-content="<?php echo lang('todays_summary'); ?>">
            ...
            <div class="header_part_right">
                <ul class="btn__menu">
                    ...
                    <li><a href="#" data-status="bar"
                           class="veg_bev_item bg__khoyre"><?php echo lang('bar_items'); ?></a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="main_left">
                    <div class="holder">
                        ...
                        <div class="ir_pa_b_w100" id="left_side_button_holder_absolute">
                            ...
                            <?php if($getCompanyInfo->pre_or_post_payment == "Post Payment"){?>
							<button class="operation_button fix"
                           ...
                           <!-- <div class="ir_flex_jc_w94_pr">
                            ...
                            <?php
                            if(isset($waiter_app_status) && $waiter_app_status=="Yes" && $getCompanyInfo->printing_kot!="web_browser"):
                                ?>
                                <div class="ir_flex_jc_w94_pr">
                            ...
                            <?php
                            if(isset($waiter_app_status) && $waiter_app_status=="Yes" && $getCompanyInfo->printing_bot!="web_browser"):
                                ?>
                                <div class="ir_flex_jc_w94_pr">
                                    <button class="operation_button fix ir_calc_w98_m5 btn_tip full-width-for-waiter"
                                            id="print_bot"
                            ...
                            ?>
                            <?php
                            if(isset($waiter_app_status) && $waiter_app_status=="Yes" && $getCompanyInfo->printing_bill=="web_browser"):
                                ?>
                                <div class="ir_flex_jc_w94_pr">
                                    <button class="operation_button fix ir_calc_w98_m5 btn_tip full-width-for-waiter"
                                ...
                                <?php
                            elseif(isset($waiter_app_status) && $waiter_app_status=="Yes" && $getCompanyInfo->printing_bill!="web_browser"):
                                ?>
                                <div class="ir_flex_jc_w94_pr">
                                    <button class="operation_button fix ir_calc_w98_m5 btn_tip full-width-for-waiter"
                ...
                <div class="main_middle">
                    <div class="main_top fix">
                        ...
                        <div class="button_holder no-need-for-waiter">
                            ...
                            <button class="selected__btn_c" id="swiggy_button"><i class="fal fa-truck"></i>
                                <?php echo lang('swiggy'); ?></button>

                            <button class="selected__btn_c" id="zomato_button"><i class="fal fa-truck"></i>
                                <?php echo lang('zomato'); ?></button>

                            <button class="selected__btn_c" id="channel1_button"><i class="fal fa-truck"></i>
                                <?php echo lang('channel1'); ?></button>

                            <button class="selected__btn_c" id="channel2_button"><i class="fal fa-truck"></i>
                                <?php echo lang('channel2'); ?></button>

                            <button class="selected__btn_c" id="channel3_button"><i class="fal fa-truck"></i>
                                <?php echo lang('channel3'); ?></button>
    ...
    <div class="all__menus">
        <ul class="menu__list">
            <div>
                ...
                <li><a href="#" data-status="bar" class="veg_bev_item"><?php echo lang('bar_items'); ?></a></li>
                <li>
    ...
    <div class="cus_pos_modal" id="today_summury_modal">
        <header class="pos__modal__header">
            <h3 class="pos__modal__title"><?php echo lang('todays_summary'); ?></h3>
            <a href="javascript:void(0)" class="pos__modal__close"><i class="fal fa-times"></i></a>
        </header>

        <div class="pos__modal__body">
            <div class="default_inner_body" id="today_details_content">
        ...
        <ul class="pos__menu__list scrollbar-macosx">
            ...
            <li class="have_sub_menu">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li style="display: <?php echo $show_status?>;"><a href="<?php echo $base_url_g1?>"><i class="fa fa-angle-double-right"></i>
            ...
            <?php }else if($value_menu->controller_name!="Plugin"){
                        ...
                        ?>
            <li style="display: <?php echo $show_status?>;" >
                <?php
                            $label = lang($value_menu->label);
