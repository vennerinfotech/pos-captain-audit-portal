                ...
                <table id="datatable" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php $data['customer_information'] = $this->Common_model->getDataById($value->customer_id, "tbl_customers"); echo escape_output($data['customer_information']->name) ?></td>
