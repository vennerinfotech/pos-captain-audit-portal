...
<body>
    <div id="wrapper">
        <div id="receiptData">
            ...
            <div id="receipt-data">
                <div class="ir_txt_center" style="font-size: 11px;">
                    <h6 class="ir_txt_center"><?php echo lang('KOT'); ?></h6>
                  <?php echo lang('Invoice_No'); ?><b>:</b> <?php echo escape_output($kot_info->order_number); ?><br>
                   <?php echo lang('date'); ?><b>: </b> <?php echo escape_output($kot_info->order_date); ?> <br>
                <?php echo lang('customer'); ?><b>: </b>
                   ...
                   <!--<?php echo lang('waiter'); ?><b>:</b> <?php echo "$kot_info->waiter_name"; ?>,<?php echo lang('order_type'); ?>:
                ...
                <table class="table table-condensed">
                    <thead>
                        <tr class="ir_font_bold">
                            <td class="ir_w_5" style="font-size: 11px;"><?php echo lang('sn'); ?></td>
                            <td class="ir_w_85" style="font-size: 11px;"><?php echo lang('item'); ?></td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="ir_txt_center" style="font-size: 11px;"><?php echo ($row->tmp_qty) ?> </td>
                        </tr>
                        <?php
                                endif;
                                }
                    ...
                    <tfoot>
                        <tr>
                            <th class="ir_txt_center" colspan="6" style="font-size: 11px;"><?php echo lang('Total_Item_s'); ?>: <?php echo escape_output($totalItems); ?></th>
                        </tr>
                    </tfoot>
                </table>
