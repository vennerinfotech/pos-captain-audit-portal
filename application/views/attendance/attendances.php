        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <a class="btn_list m-right btn bg-blue-btn" href="<?php echo base_url() ?>Attendance/addEditAttendance">
                    <i data-feather="plus"></i> <?php echo lang('sign_in'); ?>
                </a>
            </div>
        </div>
    </section>
                    ...
                    <table id="datatable" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php 
                                            echo '<a href="'. base_url().'Attendance/addEditAttendance/'. $value->id .'">'.lang('sign_out').'</a>';
                                        ?>
                                </td>
                                <td><?php echo escape_output(staffName($value->employee_id)); ?></td>
                                ...
                                <?php if($value->in_img != ""){?>
                                <td><img style="height: 50px;width: 50px;" src="<?php echo escape_output(str_replace('[removed]', 'data:image/jpeg;base64,', $value->in_img)) ?>"></td>
                                <?php }else{ ?>
                                    <td><img style="height: 50px;width: 50px;" src="../assets/media/logofm.png"></td>
                                <?php } ?>
                                <td>
                                    <?php 
                                ...
                                <?php if($value->out_img != ""){?>
                                    <td><img style="height: 50px;width: 50px;" src="<?php echo escape_output(str_replace('[removed]', 'data:image/jpeg;base64,', $value->out_img)) ?>"></td>
                                <?php }else{ ?>
                                    <td><img style="height: 50px;width: 50px;" src="../assets/media/logofm.png"></td>
                                <?php } ?>
                                <td>
