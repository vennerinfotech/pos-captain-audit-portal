            ...
            <div class="table-box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <!-- Food license Added by Kartik -->
                        <div class="col-sm-12 mb-2 col-md-6">

                            <div class="form-group">
                                <label><?php echo lang('Foodlicense_Registration_No'); ?></label>
                                <input tabindex="4" autocomplete="off" type="text" name="foodlicense" class="form-control" placeholder="<?php echo lang('Foodlicense_Registration_No'); ?>" value="<?php echo escape_output($outlet_information->foodlicense); ?>" />
                            </div>
                            <?php if (form_error('foodlicense')) { ?>
                                <div class="callout callout-danger my-2">
                                    <?php echo form_error('foodlicense'); ?>
                                </div>
                            <?php } ?>
						...
						<div class="col-sm-12 mb-2 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="4" autocomplete="off" type="text" name="gstnumber" class="form-control" placeholder="<?php echo lang('gst_number'); ?>" value="<?php echo escape_output($outlet_information->gstnumber); ?>" />
                            </div>
                            <?php if (form_error('gstnumber')) { ?>
                                <div class="callout callout-danger my-2">
                                    <?php echo form_error('gstnumber'); ?>
                                </div>
                            <?php } ?>
