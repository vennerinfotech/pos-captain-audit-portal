            ...
            <div class="row">
                        ...
                        <div class="col-sm-12 mb-2 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="4" autocomplete="off" type="text" name="foodlicense" class="form-control" placeholder="<?php echo lang('Foodlicense_Registration_No'); ?>" value="<?php echo set_value('foodlicense'); ?>" />
                            </div>
						...
						<div class="col-sm-12 mb-2 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input tabindex="4" autocomplete="off" type="text" name="gstnumber" class="form-control" placeholder="<?php echo lang('gst_number'); ?>" value="<?php echo set_value('gstnumber'); ?>" />
                            </div>
