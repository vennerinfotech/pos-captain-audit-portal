            ...
            <div class="item">
                <div class="single-feature-inner bg-gradient">
                    ...
                    <div class="details">
                        ...
                        <p>When you place an order, that will directly been popped up in the kitchen panel, when the item is ready your POS will show notification, your champion will also get notified. You can even generate a kitchen performance report to know that how much time they are taking to make food. And also when a customer asks that what is the status of his food or how long his food will take to come to the table, you can simply check that from the POS screen. In these ways you can optimizes lot of interactions between your staffs that may reduce unnecessary waste of time. And overseeing kitchen performance report you will have more control to improve kitchen performance.</p>
                    </div>
                </div>
            </div>
            <div class="item">
                ...
                <div class="col-md-6">
                    <div class="card single-faq-inner">
                        ...
                        <div id="f-one" class="collapse" aria-labelledby="ff-one" data-parent="#accordion">
                            <div class="card-body">
                                <?php echo escape_output($site_name)?> is a complete solution for a restaurant where you will get Recipe Management, Stock Auto Deduct by Recipe on Sale, Powerful POS, Kitchen/Bar/Champion Panel, CRM, SMS, Veg & Bar Item Filter.
                            </div>
                        </div>
                    </div>
                    <div class="card single-faq-inner">
