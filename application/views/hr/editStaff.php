...
<section class="main-content-wrapper">
    ...
    <div class="box-wrapper">   
        <div class="table-box">
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open(base_url('Hr/addEditStaff/'. $encrypted_id)); ?>
            <div>
                <div class="row">
                    <div class="col-sm-12 mb-2 col-md-6">
                            ...
                            <select tabindex="3" class="form-control select2 ir_w_100" name="category_id">
                                ...
                                <?php foreach ($outlets as $ec) { ?>
                                    <option value="<?php echo escape_output($ec->id) ?>" <?php
                                        if ($staff_information->outlet_id == $ec->id) {
                                            echo "selected";
                                        }
                                        ?>>
                                        <?php echo escape_output($ec->outlet_name) ?>
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            value="<?php echo escape_output($staff_information->staff_name) ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            value="<?php echo escape_output($staff_information->staff_designation) ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            value="<?php echo escape_output($staff_information->staff_salary) ?>">
                        </div>
                    ...
                    <div class="col-sm-12 mb-2 col-md-6">
                        <div class="form-group">
                            ...
                            <input tabindex="2" type="text" name="phone" class="form-control integerchk"
                                ...
                                value="<?php echo escape_output($staff_information->staff_phone) ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            value="<?php echo escape_output($staff_information->staff_description) ?>">
                        </div>
