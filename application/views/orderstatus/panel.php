...
<body>
        ...
        <div class="fix main_top">
            <div class="row">
                <div class="top_header col-sm-12 col-md-4">
                    <h1><?php echo lang('orderstatus_panel'); ?></h1>
                </div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/orderstatus_panel/js/marquee.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/orderstatus_panel/js/datable.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/orderstatus_panel/js/jquery.cookie.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/POS/js/howler.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/orderstatus_panel/js/custom.js"></script>
    <!-- material icon -->
