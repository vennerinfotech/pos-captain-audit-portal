                        ...
                        <tbody>
                            ...
                            if (isset($detailedSaleReport)):
                                foreach ($detailedSaleReport as $key => $value) {
                                    ...
                                    $key++;
									$totalcharges += $value->delivery_charge_actual_charge;
                                    ?>
                            <tr>
								...
								<td><?php echo escape_output($value->delivery_charge_actual_charge) ?>
                            ...
                            <tr>
                                ...
                                <th><?php echo escape_output(getAmt($totalcharges)) ?></th>
