    ...
    public function addEditOutlet($encrypted_id = "") {
        ...
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $outlet_info['foodlicense'] =htmlspecialchars($this->input->post($this->security->xss_clean('foodlicense')));
				$outlet_info['gstnumber'] =htmlspecialchars($this->input->post($this->security->xss_clean('gstnumber')));
                ...
                if(str_rot13($language_manifesto)=="eriutoeri"):
                    ...
                    if($item_check){
                        ...
                        for($i=0;$i<$total_selected;$i++){
                            ...
                            $data_price_array["tmp".$item_check[$i]] = htmlspecialchars($this->input->post($this->security->xss_clean("price_".$item_check[$i])));
