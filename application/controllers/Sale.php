...
class Sale extends Cl_Controller {
    ...
    public function delete_specific_order_by_sale_id($sale_id){
        ...
        $this->db->where('id', $sale_id);
        $this->db->update('tbl_sales', array('del_status' => 'canceled'));
        $this->db->where('sales_id', $sale_id);
        $this->db->update('tbl_sales_details', array('del_status' => 'canceled'));
        $this->db->update('tbl_sales_details_modifiers', array('del_status' => 'canceled'));
        $this->db->update('tbl_sale_consumptions_of_menus', array('del_status' => 'canceled'));
        $this->db->update('tbl_sale_consumptions_of_modifiers_of_menus', array('del_status' => 'canceled'));
        $this->db->where('sale_id', $sale_id);
        $this->db->update('tbl_sale_consumptions', array('del_status' => 'canceled'));
        $this->db->update('tbl_orders_table', array('del_status' => 'canceled'));
